#######################################################################################
# FirstName/Surname: Jarupong Thongmark
# Student ID: 65070031
# Github repository URL: https://github.com/Puay47/NPA2023-Final-Example
#######################################################################################
# Instruction
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    if message.find("/jarupong") == 0:
        ...
        location = message[len("/jarupong "):].strip()
...
# 5. Prepare openweather Geocoding APIGetParameters..
        ...
        openweatherGeoAPIGetParameters = {
            "q": location,
            "limit": 1,
            "appid": "3dc92ba4ab7637f2a701c3fedb7d0d1d",
        }
